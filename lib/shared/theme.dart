...
Color colorMain = const Color(0xff5827D8);
Color colorGrey = const Color(0xffA5A5A5);
Color colorGreyWhite = const Color(0xffeeeeee);
Color colorGreyDark = const Color(0xff6C6C6C);
Color colorRed = const Color(0xffE80000);
